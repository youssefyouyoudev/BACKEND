...
use App\Http\Controllers\Web\Admin\MatchQualificationController as AdminMatchQualificationController;
...
Route::middleware(['auth', 'admin'])->prefix('admin')->group(function (): void {
    ...
    Route::get('/world-cup-matches/{world_cup_match}/qualify', [AdminMatchQualificationController::class, 'edit'])
        ->name('admin.world-cup-matches.qualify.edit');
    Route::post('/world-cup-matches/{world_cup_match}/qualify', [AdminMatchQualificationController::class, 'update'])
        ->name('admin.world-cup-matches.qualify.update');
